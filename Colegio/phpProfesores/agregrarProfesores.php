...
//Realizamos la consulta donde nos mostrara todos lo datos donde el Departamento sea igual a=?  
$departamentos = "SELECT * FROM DEPARTAMENTOS";
$stmt = $llamarMetodo->prepare($departamentos);
//Ejecutamos la consulta
$stmt->execute();
?>
<!--Mostramos el formulario para ingresar un Profesor-->
<div align="center" class="col-sm-12">
    <!--Creamos un formulario para ingresar un Profesor con validaciones-->
        ...
        <table whited="30%" class="table display alert-secondary mt-3" >
            <tr>
                <td align="center">
                    ...
                    <input type="text" class="form-control my-3 text-black" id="txt_codigo_Profesor" name="codigo" placeholder="Ingrese el Código" autofocus>
                </td>
            </tr>
            <tr>
                
                <td align="center">
                    <select name="" id="txt_codigo_Departamentos" class="form-control my-3 text-black">
            ...
            <td align="center">
                <!--Creamos el txt nombre con un id y un nombre-->
                <input type="text" class="form-control my-3 text-black" id="txt_Rut" name="rut" placeholder="Ingrese el Rut" autofocus>
            </td>
            </tr>
            <tr>
                <td align="center">
                    <!--Creamos el txt nombre con un id y un nombre-->
                    <input type="text" class="form-control my-3 text-black" id="txt_Nombres" name="nombres" placeholder="Ingrese los Nombres" autofocus>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <!--Creamos el txt nombre con un id y un nombre-->
                    <input type="text" class="form-control my-3 text-black" id="txt_Apellido_Paterno" name="apellido_Paterno" placeholder="Ingrese el Apellido Paterno" autofocus>
                </td>
            </tr>
            <tr>
                <td>
                    <!--Creamos el txt email con un id y un nombre-->
                    <input type="text" class="form-control my-3" id="txt_Apellido_Materno" name="apellido_Materno" placeholder="Ingrese el Apellido Materno"></td>
            </tr>
            <tr>
                <td>
                    <!--Creamos el txt pais con un id y un nombre-->
                    <input type="date" class="form-control my-3" id="txt_Fecha_Nacimiento" name="fecha" placeholder="el mes dia y año de Nacimiento">
                </td>
            </tr>
            <tr>
                <td align="center">
            ...
            <tr>
                <td>
                    <!--Creamos el txt pais con un id y un nombre-->
                    <input type="text" class="form-control my-3" id="txt_Calle" name="calle" placeholder="Ingrese el Nombre de la calle"></td>
            </tr>
            <tr>
                <td>
                    <!--Creamos el txt pais con un id y un nombre-->
                    <input type="text" class="form-control my-3" id="txt_Numero" name="numero" placeholder="Ingrese el Número "></td>
            </tr>
            <tr>
                <td>
                    <!--Creamos el txt pais con un id y un nombre-->
                    <input type="text" class="form-control my-3" id="txt_Ciudad" name="ciudad" placeholder="Ingrese el nombre de la Ciudad"></td>
            </tr>
        </table>
        <!-- BOTON QUE TIENE EL EVENTO QUE DISPARA LA FUNCION PARA VALIDAR-->
        <button onclick="agregarProfesores()" class="btn btn-primary mt-3" id="btn">
            <b>Guardar</b></button>
    </form>
</div>
